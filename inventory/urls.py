...
urlpatterns = [
    ...
    path('reports/all-sales/', views_report.all_sales_report, name='all_sales_report'),
    path('reports/receivable/', views_report.receivable_report, name='receivable_report'),
    path('reports/payable/', views_report.payable_report, name='payable_report'),
